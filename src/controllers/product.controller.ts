...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, StatusCodes.CREATED, 'Product created successfully.', product);
  } catch (error: any) {
...
export const getAll = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, StatusCodes.OK, 'Products fetched successfully.', products);
  } catch (error: any) {
...
export const getById = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, StatusCodes.OK, 'Product details fetched successfully.', product);
  } catch (error: any) {
    return errorResponse(res, StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
export const update = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, StatusCodes.OK, 'Product updated successfully.', product);
  } catch (error: any) {
    return errorResponse(res, StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
export const updateStock = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, StatusCodes.OK, 'Stock updated successfully.', updatedProduct);
  } catch (error: any) {
